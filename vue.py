...
class SnakeVue:
    ...
    def displayGame(self, game):
        ...
        pygame.draw.rect(
            self.game_window,
            color,
            pygame.Rect(0, 0, self.width * self.scale, self.height * self.scale),
        )
        self.game_window.blit(
            self.image_fruit, (game.fruit[0] * self.scale, game.fruit[1] * self.scale)
        )
        for idx, body in enumerate(game.serpent):
            ...
            if idx == len(game.serpent) - 1:
                ...
                continue
            if (
                game.serpent[idx + 1][0] == game.serpent[idx][0] + 1
                and game.serpent[idx - 1][1] == game.serpent[idx][1] - 1
            ) or (
                game.serpent[idx - 1][0] == game.serpent[idx][0] + 1
                and game.serpent[idx + 1][1] == game.serpent[idx][1] - 1
            ):
                ...
                game.serpent[idx + 1][1] == game.serpent[idx][1] + 1
                and game.serpent[idx - 1][0] == game.serpent[idx][0] + 1
            ) or (
                game.serpent[idx - 1][1] == game.serpent[idx][1] + 1
                and game.serpent[idx + 1][0] == game.serpent[idx][0] + 1
            ):
            ...
            elif (game.serpent[idx + 1][0] == game.serpent[idx][0] - 1) or (
                game.serpent[idx - 1][0] == game.serpent[idx][0] - 1
            ):
